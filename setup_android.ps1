...
# Copiar o arquivo de Macro para a memória interna do celular (Internal Storage)
Write-Host "`n   -> Enviando backup de macros (Geely_Auto_Connect.xml)..." -NoNewline
# Usa o caminho padrao do Android moderno (/storage/emulated/0/Download)
& $adb push "$PSScriptRoot\Geely_Auto_Connect.xml" /storage/emulated/0/Download/ 2>$null
Write-Host " [OK]" -ForegroundColor Green
